...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Opensourcepolitics Monitor web application."
  #
  #
  ...
  #
  # settings.secret_key_base= lGuEQhsUMi_c2vP0DKvi5iqNfgY2uG2PLOnA7uo_S5s
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("opensourcepolitics-monitor.log", "w"))
  #
  #
end
